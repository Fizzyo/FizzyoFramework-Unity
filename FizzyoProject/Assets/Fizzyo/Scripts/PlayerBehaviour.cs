...
public class PlayerBehaviour : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        ButtonText.gameObject.SetActive(buttonPressed);
    }
    ...
    void Update () {
        if (!waitingForInput)
        {
            ...
            if (!buttonPressed && ( FizzyoFramework.Instance.Device.ButtonDown() || Input.GetKeyDown(KeyCode.Space)))
            {
                buttonPressed = true;
                ButtonText.gameObject.SetActive(buttonPressed);
            }
            else if (FizzyoFramework.Instance.Device.ButtonDown() || Input.GetKeyDown(KeyCode.Space))
            {
                buttonPressed = false;
                ButtonText.gameObject.SetActive(buttonPressed);
            }
